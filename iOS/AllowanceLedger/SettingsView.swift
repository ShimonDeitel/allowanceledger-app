...
struct SettingsView: View {
    ...
    @AppStorage("allowanceledger_notifyEnabled") private var notifyEnabled = true
    @AppStorage("allowanceledger_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/allowanceledger-app/privacy.html")!)
                    Text("Version 1.0")
